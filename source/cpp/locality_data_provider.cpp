...
void LocalityDataProvider::renameRoute(const QString &oldName, const QString &newName) const {
    QFile file (routeNameToFileName(oldName));
    file.rename(routeNameToFileName(newName));
}
